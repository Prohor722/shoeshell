        ...
        <>
            <div className='cover-container row m-0'>
                <div className='d-flex flex-column align-items-center justify-content-center intro col-md-8 m-0 p-0'>
                    ...
                    <p className='w-50 mt-3'>We are working day and night to provide you the best design and long lasting quality from <span className='site-color'>ShoeShell</span> to your feet.</p>
                </div>
